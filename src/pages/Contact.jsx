...
const contactItems = [
  ...
  },
  {
    ...
    value: '78 838 20 20',
    href: 'tel:+221788382020',
    short: '+221 78 838 20 20',
  },
  {
    id: 'contact-address',
    icon: '📍',
      ...
      >
        <div className="container">
          ...
          <h1 style={{ fontSize: 'clamp(1.8rem, 4vw, 2.8rem)', fontWeight: 800, marginBottom: '1rem', lineHeight: 1.2 }}>
            Votre projet eau commence ici
          </h1>
          <p style={{ color: 'rgba(255,255,255,0.75)', fontSize: '1.05rem', maxWidth: '620px', lineHeight: 1.7, marginBottom: '2rem' }}>
            Dites-nous où vous êtes. Nous venons à vous. Remplissez le formulaire, appelez-nous ou passez directement à nos bureaux. 
            Notre équipe vous répond rapidement pour étudier votre besoin et vous proposer la meilleure solution.
          </p>
          <div style={{ display: 'flex', gap: '1.5rem', flexWrap: 'wrap' }}>
            {['Devis gratuit', 'Pas d\'engagement', 'Réponse rapide'].map(benefit => (
              <div key={benefit} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '0.9rem', color: '#fff' }}>
                <span style={{ color: 'var(--color-accent)' }}>✓</span> {benefit}
              </div>
            ))}
          </div>
        </div>
